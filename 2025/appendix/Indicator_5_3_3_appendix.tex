...
is based on nearly 590,000 press releases from political parties in 24
...
in only about one percent of their press releases in 2025.
...
releases. The indicator is based on nearly 590,000 press releases from
political parties in 24 EU countries and the UK, covering a period from
...
nexus in only about one percent of their press releases in 2025.

\subsubsection{Geographic coverage of
Europe}\label{geographic-coverage-of-europe}

This indicator covers 24 EU countries and the UK. The countries included
...
Czech Republic, Belgium, Romania, and Lithuania. The countries were
selected based on the availability of press releases from political
parties.
...
The model was trained on a dataset of over 136,000 examples drawn from
three complementary sources: zero-shot labels generated by OpenAI's
GPT-4.1-nano and GPT-5-mini models, and publicly available human-coded
press release data from the Comparative Agendas Project
\citep{walgrave2019comparative}. Zero-shot labels were produced by
submitting randomly sampled press releases to the OpenAI Batch API,
asking each model to classify the primary substantive focus of the press
release according to the modified CAP classification scheme. A
multilingual XLM-RoBERTa-large model pre-trained by Facebook AI
\citep{xlm_roberta} was used as the base model for the fine-tuning
process. The model achieved a weighted F1 score of 0.74 on a held-out
test set of 20,421 examples, indicating strong accuracy in predicting
the substantive focus of multilingual press releases. Full results of
the model evaluation are presented below. The model has been made
publicly available on HuggingFace at:
...
included 585,619 press releases from political parties across 24 EU
...
model was trained on a dataset of over 136,000 examples, but it is
